...
- [[exampleTorus][=exampleTorus=]] :: demonstrate that the algorithm successfully embeds a 2-torus

- [[exampleDynamics][=exampleDynamics=]] :: demonstrate how algorithm is used on trajectories of a dynamical system
